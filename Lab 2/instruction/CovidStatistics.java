...
public static void main(String[] args)
 {
   ...
   */
   ...
   // TO DO: WRITE YOUR CODE FOR THIS SECTION HERE!!!! Check the sample output file (CovidSample.txt) to see the expected pattern to print out these details using printf.
   ...
   */ 
   ...
   // TO DO: INSERT CODE HERE FOR THIS SECTION!!! Check the sample output file (CovidSample.txt) to see the expected pattern.
